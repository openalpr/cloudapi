...
public class InlineResponse200   {
  ...
  public enum DataTypeEnum {
    @SerializedName("alpr_results")
    ALPR_RESULTS("alpr_results"),
    
    @SerializedName("alpr_group")
  ...
  **/
   ...
   * @return imgWidth
  **/
  @ApiModelProperty(example = "null", value = "Width of the uploaded image in pixels")
   ...
   * @return imgHeight
  **/
  @ApiModelProperty(example = "null", value = "Height of the input image in pixels")
   ...
   * @return creditCost
  **/
  @ApiModelProperty(example = "null", value = "The number of API credits that were used to process this image")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of API credits used this month")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The maximum number of API credits available this month according to your plan")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Describes the areas analyzed in the input image")
   ...
   * @return epochTime
  **/
  @ApiModelProperty(example = "null", value = "Epoch time that the image was processed in milliseconds")
   ...
   * @return version
  **/
  @ApiModelProperty(example = "null", value = "API format version")
   ...
   * @return dataType
  **/
  @ApiModelProperty(example = "null", value = "Specifies the type of data in this response")
